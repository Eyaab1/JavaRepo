...
public class Zoo {
 ...
 public void addAnimal(Animal animal) throws ZooFullException {
        if (isZooFull()) {
            throw new ZooFullException("Le zoo est plein" + animal.getName());
        }
        ...
        if (animal.getAge() < 0) {
            System.out.println("age invalide pour : " + animal.getName());
            return;
        }

        animals[nbrCag] = animal;
        nbrCag++;
        System.out.println("✅ Animal ajouté : " + animal.getName() + " | Total d'animaux = " + nbrCag);
    }
